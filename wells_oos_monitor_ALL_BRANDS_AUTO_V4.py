...
def run_brand(cfg: Dict, page) -> Dict:
    ...
    log(f"{label}: OOS atuais: {len(current_oos)} produtos / {current_count_variants} variantes | NOVOS OOS: {len(new_oos)}")
...
def main() -> None:
    ...
    for r in results:
        ...
        body_lines.append(f"  OOS atuais: {r.get('current_count_variants', r['current_count'])} | NOVOS OOS: {r['new_count']}\n")
