    ...
    if len(variants) <= 1:
        ...
        for tile in variants:
            ...
            try:
                ...
                # Não depende de "mudança" — lê o valor actual após a REF ter atualizado
                page.wait_for_timeout(400)  # pequena pausa inicial para AJAX do badge
                _badge = ''
                for _d in range(10):
                    page.wait_for_timeout(200)
                    try:
