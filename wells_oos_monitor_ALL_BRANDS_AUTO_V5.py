...
def run_brand(cfg: Dict, page) -> Dict:
    ...
    if multi_brand:
        ...
        # FILTRO SIMPLIFICADO para Oral Care
        # O Wells já filtra por marca (prefn1=brand&prefv1=X), então confiamos nisso
        # Só rejeitamos marcas CONHECIDAS que não são Pierre Fabre (IT Cosmetics, Lancôme, NYX, etc)
        ...
        for url in all_urls_collected:
            ...
            # Aceita todo o resto (confiamos no filtro &prefn1=brand do Wells)
