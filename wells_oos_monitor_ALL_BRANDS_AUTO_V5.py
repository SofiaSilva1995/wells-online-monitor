...
<div class="wrap">
  ...
  <div class="sec-body open" id="bodyOos"><div class="chart-card">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
      ...
      <button id="btnChartReset" style="padding:4px 14px;height:28px;border-radius:8px;background:var(--blue-pale);color:var(--blue);border:1.5px solid var(--blue-mid);font-size:12px;font-weight:700;font-family:inherit;cursor:pointer;transition:background .15s">↺ Mostrar todas</button>
    </div>
...
var DATA = {{DATA_JSON}};
DATA = DATA.map(function(r){{ if(r.is_removed) return Object.assign({{}},r,{{_removed:true}}); return r; }});  // Run atual (hoje)
