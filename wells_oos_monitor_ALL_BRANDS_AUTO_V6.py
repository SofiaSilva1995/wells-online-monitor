...
def run_brand(cfg: Dict, page) -> Dict:
    ...
    if multi_brand:
        ...
        all_urls = all_urls_collected
        variant_candidates = set()  # Multi-brand não usa variant_candidates por agora
        total = None
        log(f"{label}: Multi-brand collected {len(all_urls)} URLs total")
    
    # ---- Expandir URLs de variantes (comum para ambos os modos) ----
...
<div class="header">
  ...
  <div class="header-text">
    ...
    <div class="sub">Avène &nbsp;·&nbsp; Ducray &nbsp;·&nbsp; Klorane &nbsp;·&nbsp; René Furterer &nbsp;·&nbsp; A-Derma &nbsp;·&nbsp; Oral Care &nbsp;·&nbsp; Wells.pt</div>
  </div>
